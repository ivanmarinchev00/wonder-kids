...
const GameComponent = (props) => {
  ...
  const [showQuestion, setShowQuestion] = useState("topic");
  ...
  return (
    <div className="container">
      <div className="row score-row justify-content-between">
        <div className="col-4">
          <Link to="/menu">
            <svg
        ...
        <div class="row justify-content-center">
          <h2 class="sign">
            {showQuestion === "province"
              ? lastPQuestion.question
